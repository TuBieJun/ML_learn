...
if __name__ == "__main__":
    ...
    #estimate model
    print "Accuracy of sgdc classifiter%s"%(sgdc.score(x_test, y_test))
    print classification_report(y_test, sgdc_y_predict, target_names=["positive", "negative"])

    #save the model 
    joblib.dump(sgdc, "sgdc_model.m")
